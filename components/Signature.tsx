  ...
  return (
    <span className="inline-block overflow-hidden pb-[0.22em] -mb-[0.22em] pr-[0.06em] -mr-[0.06em]" aria-hidden>
      <motion.span
        ...
        style={amber ? { color: "#E8920A" } : undefined}
      >
        {char === " " ? "\u00A0" : char}
      </motion.span>
    </span>
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 py-24 md:py-36">
        ...
        <motion.p
          ...
          className="text-[9px] font-mono text-[#E8920A]/65 tracking-[0.5em] uppercase mb-10">
          {tr.sectionLabel}
        </motion.p>
        ...
        >
          ...
          <a
            href={tr.cta1.href}
            className="group inline-flex items-center gap-2.5 px-8 py-3.5 rounded-full bg-[#111111] text-white text-sm font-medium tracking-wide hover:bg-[#E8920A] transition-colors duration-300"
          >
            {tr.cta1.label}
            <motion.span
              animate={{ x: [0, 4, 0] }}
          ...
          <a
            href={tr.cta2.href}
            className="group inline-flex items-center gap-2.5 px-8 py-3.5 rounded-full border border-[#111111]/15 text-[#111111]/55 text-sm font-medium tracking-wide hover:border-[#E8920A]/40 hover:text-[#E8920A] transition-colors duration-300"
          >
            {tr.cta2.label}
