        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 border border-[#111111]/[0.08] divide-x divide-[#111111]/[0.08] rounded-2xl overflow-hidden bg-white">
          {tr.stats.map((s, i) => (
            ...
            >
              ...
              <p className="mt-2 text-[10px] font-semibold tracking-[0.22em] uppercase text-[#E8920A]">
                {s.label}
              </p>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 xl:px-16 pb-24 md:pb-32">
        <div className="grid grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            >
              <p
                className="text-[#E8920A] text-xl font-bold"
          ...
          >
            <p className="text-[9px] font-mono text-[#E8920A] tracking-[0.38em] uppercase mb-6">
              {tr.sectionLabel}
            </p>
            ...
            >
              ...
              <br />
              {tr.headlineLine3}
              <span style={{ color: "#E8920A" }}>{tr.headlineAccent}</span>
            </h2>
            ...
            <ul className="mt-9 space-y-4">
              {tr.points.map((point, i) => (
                ...
                >
                  <span className="mt-2 w-1 h-1 rounded-full flex-shrink-0 bg-[#E8920A]" />
                  {point}
                </motion.li>
              ))}
            </ul>
