      ...
      <div className="max-w-[1440px] mx-auto px-12 md:px-20 xl:px-28">
        ...
        <div className="relative h-px bg-[#1A1A1A]/8 mb-14 md:mb-20 overflow-hidden">
          <motion.div
            ...
            className="absolute inset-0 bg-[#E8920A]"
          />
        </div>
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 md:col-span-10 md:col-start-2">
            ...
            >
              ...
              >
                <span style={{ color: "#E8920A" }}>{tr.h1}</span>{tr.h1rest}
              </h2>
            </motion.div>
        ...
        >
          {pillars.map((p, i) => (
            ...
            >
              <p
                className="text-[9px] font-mono tracking-[0.32em] uppercase text-[#E8920A] mb-3"
              >
