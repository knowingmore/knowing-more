      ...
      <section className="relative pt-28 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12 xl:px-16">
          ...
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
            ...
            <Link href="/pl" className="hover:text-[#111111]/60 transition-colors">Strona główna</Link>
            <span>/</span>
            <Link href="/pl/store" className="hover:text-[#111111]/60 transition-colors">Sklep</Link>
            <span>/</span>
                  ...
                  {activeImg === 0 ? (
                    <motion.div key="product" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                      ...
                      <motion.div animate={{ opacity: imgHovered ? 1 : 0, scale: imgHovered ? 1 : 1.04 }}
                        ...
                        <Image src={p.hoverImg} alt={`${p.name} w użyciu`} fill className="object-cover" />
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 xl:px-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden aspect-[16/9]">
              <Image src={p.accentImg} alt="Sposób użycia" fill className="object-cover" sizes="600px" />
      ...
      <section className="py-16 border-t border-[#111111]/[0.06]">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 xl:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {others.map((other) => (
              <Link key={other.slug} href={`/pl/store/${other.slug}`}
