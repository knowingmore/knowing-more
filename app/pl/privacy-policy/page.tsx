      ...
      <section className="pt-36 pb-24 px-6 md:px-12 xl:px-16 max-w-[1440px] mx-auto">
        ...
        <div className="max-w-[720px] space-y-10 text-sm text-[#111111]/50 leading-relaxed">
          ...
          {[
            ...
            { title: "9. Administrator danych i kontakt", body: "Administrator danych (na etapie weryfikacji rynkowej / pre-market): knowing more. — operator strony knowingmore.life. Kontakt we wszelkich kwestiach związanych z prywatnością: privacy@knowingmore.life. Przed uruchomieniem sprzedaży zostanie zarejestrowany podmiot prawny, a zarejestrowani użytkownicy zostaną poinformowani o zmianie." },
          ].map((s) => (
            <div key={s.title}>
