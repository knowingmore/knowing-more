  ...
  return (
    ...
    >
      ...
      <div className="p-10 md:p-14 flex flex-col justify-center">
        ...
        <h2 className="text-2xl md:text-3xl font-bold tracking-[-0.02em] text-[#111111] mb-4 leading-tight group-hover:text-[#E8920A] transition-colors duration-300"
          style={{ fontFamily: "var(--font-playfair)" }}>
          {post.title}<span style={{ color: "#E8920A" }}>.</span>
        </h2>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm text-[#E8920A] group-hover:translate-x-1 transition-transform duration-200 inline-block">→</span>
        </div>
      </div>
    </motion.div>
  );
...
function PostCard({ post, i }: { post: typeof posts[0]; i: number }) {
  return (
    ...
    >
      ...
      <h3 className="text-base md:text-lg font-bold tracking-[-0.02em] text-[#111111] mb-2 leading-snug group-hover:text-[#E8920A] transition-colors duration-300"
        style={{ fontFamily: "var(--font-playfair)" }}>
        {post.title}
      </h3>
      <p className="text-sm text-[#111111]/38 leading-[1.8] line-clamp-3">{post.excerpt}</p>
      <div className="mt-4 flex items-center gap-1.5 text-xs text-[#E8920A] font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200">
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="border-t border-[#111111]/[0.07] py-20">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 xl:px-16">
          ...
          >
            <p className="text-[9px] font-mono tracking-[0.4em] uppercase text-[#E8920A]/70 mb-4">Newsletter</p>
            <h2 className="text-2xl md:text-3xl font-bold tracking-[-0.02em] text-[#111111] mb-4"
              style={{ fontFamily: "var(--font-playfair)" }}>
              Longevity intelligence, prosto do skrzynki<span style={{ color: "#E8920A" }}>.</span>
            </h2>
