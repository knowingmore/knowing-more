  ...
  return (
    ...
    >
      <div className={flip ? "md:order-2" : ""}>
        <p className="text-[9px] font-mono tracking-[0.38em] uppercase text-[#E8920A]/70 mb-5">{p.index}</p>
        <h2 className="text-2xl md:text-3xl font-bold tracking-[-0.02em] text-[#111111] mb-5 leading-tight"
          style={{ fontFamily: "var(--font-playfair)" }}>
          {p.title}<span style={{ color: "#E8920A" }}>.</span>
        </h2>
    ...
    <main className="min-h-screen bg-white">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            {stats.map((s, i) => (
              <div key={s.label}
                ...
                <p className="mt-2 text-[9px] font-mono tracking-[0.22em] uppercase text-[#E8920A]">{s.label}</p>
      ...
      <section className="relative h-[50vh] overflow-hidden"
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-6">
          <div>
            <p className="text-[9px] font-mono tracking-[0.4em] uppercase text-[#E8920A] mb-4">The Standard</p>
