...
function FAQItem({ q, a, i }: { q: string; a: string; i: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-sm md:text-base font-medium text-[#111111] group-hover:text-[#C4682A] transition-colors duration-200">
          {q}
        </span>
        <motion.span
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 xl:px-16">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            <div className="md:col-span-4">
              <p className="text-[9px] font-mono tracking-[0.4em] uppercase text-[#C4682A]/70 mb-3">FAQ</p>
              <h2 className="text-2xl md:text-3xl font-bold tracking-[-0.02em] text-[#111111] mb-4"
                style={{ fontFamily: "var(--font-playfair)" }}>
                Common questions<span style={{ color: "#C4682A" }}>.</span>
              </h2>
      ...
      <section className="border-t border-[#111111]/[0.07] py-20">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 xl:px-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <div>
              <p className="text-[9px] font-mono tracking-[0.4em] uppercase text-[#C4682A]/70 mb-3">Contact</p>
              <h2 className="text-2xl md:text-3xl font-bold tracking-[-0.02em] text-[#111111] mb-4"
                style={{ fontFamily: "var(--font-playfair)" }}>
                Send us a message<span style={{ color: "#C4682A" }}>.</span>
              </h2>
            ...
            <div>
              <AnimatePresence mode="wait">
                {sent ? (
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-[#C4682A] flex items-center justify-center text-white text-xl">✓</div>
                    ...
                    {[
                      ...
                      <div key={field.label}>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3.5 rounded-xl text-sm border border-[#111111]/12 text-[#111111] placeholder-[#111111]/25 outline-none focus:border-[#C4682A]/40 transition-colors"
                        />
                      </div>
                    ))}
                    <div>
                      ...
                      <textarea
                        ...
                        rows={5}
                        className="w-full px-4 py-3.5 rounded-xl text-sm border border-[#111111]/12 text-[#111111] placeholder-[#111111]/25 outline-none focus:border-[#C4682A]/40 transition-colors resize-none"
                      />
                    </div>
                    <button type="submit"
