  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-36 pb-24 px-6 md:px-12 xl:px-16 max-w-[1440px] mx-auto">
        <p className="text-[9px] font-mono tracking-[0.45em] uppercase text-[#C4682A] mb-6">Contact</p>
        <h1 className="text-[clamp(3rem,6vw,6rem)] font-bold leading-[0.9] tracking-[-0.03em] text-[#111111] mb-16"
          style={{ fontFamily: "var(--font-playfair)" }}>
          Get in touch<span style={{ color: "#C4682A" }}>.</span>
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-[960px]">
          <div className="space-y-8">
            {[
              ...
              <div key={item.label}>
                ...
                <a href={`mailto:${item.value}`} className="text-sm text-[#111111] hover:text-[#C4682A] transition-colors duration-200">
                  {item.value}
                </a>
              </div>
            ))}
          ...
          {done ? (
            <div className="flex flex-col items-center justify-center gap-4 py-16 rounded-2xl border border-[#C4682A]/20 bg-[#C4682A]/5 text-center">
              ...
              {[
                ...
                <div key={f.name}>
                  ...
                  <input type={f.type} required
                    className="w-full px-4 py-3.5 rounded-full text-sm border border-[#111111]/12 bg-white text-[#111111] outline-none focus:border-[#C4682A]/50 transition-colors" />
                </div>
              ))}
              <div>
                <label className="text-[9px] font-mono tracking-[0.22em] uppercase text-[#111111]/40 block mb-2">Message</label>
                <textarea required rows={5}
                  className="w-full px-4 py-3.5 rounded-2xl text-sm border border-[#111111]/12 bg-white text-[#111111] outline-none focus:border-[#C4682A]/50 transition-colors resize-none" />
              </div>
              <button type="submit"
