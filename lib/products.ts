...
export const products: Product[] = [
  {
    ...
    gallery: [
      ...
      "/images/website/hero-movement-woman.jpg",
      "/images/website/store-performance-accent.jpg",
    ],
    color: "#111111",
  ...
  },
  {
    ...
    gallery: [
      ...
      "/images/website/store-gutHealth-hover2.png",
      "/images/website/store-gutHealth-accent.jpg",
    ],
    color: "#C4682A",
